...
![Curva da activação na zanga](figuras/zangado-curva-activacao.png)
...
Para as notas de quem aplica. **Não é instrumento, não pontua e não se
preenche com a criança à frente como se fosse um teste.**

| | |
| --- | --- |
| Data | |
| Estratégias que escolheu | |
| Estratégia que ordenou como mais fácil | |
| Alguma que já usava | |
| Pessoas que nomeou (casa) | |
| Pessoas que nomeou (fora de casa) | |
| O que disse sobre o que acontece antes | |
| Notas | |
| A retomar na próxima sessão | |
...
## 10. O que este material não faz
